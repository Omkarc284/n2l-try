...
const About = () => {
  return (
    <div className={` w-full h-full flex items-center`}>
        <div className='w-full h-full flex flex-col-reverse justify-center md:flex-row md:justify-between items-center max-w-[360px] md:max-w-[640px] lg:max-w-[1080px] xl:max-w-[1280px] mx-auto'>
            <motion.div 
              variants={slideIn("left", "tween", 0.2, 1)}
              className="flex py-6 justify-center items-center w-full md:w-1/2 md:py-0"
            >
                <img src={about} alt="" className='h-[60%] w-[60%] md:h-[60%] md:w-[60%] object-contain ' />
            </motion.div>
            <motion.div 
            ...
            >
                ...
                <h3 className='text-black font-montserrat text-center md:text-justify font-bold text-[7px] sm:text-[12px] lg:text-[18px] 2xl:text-2xl py-2 md:py-6'>Mission</h3>
                ...
                <h3 className='text-black font-montserrat text-center md:text-justify font-bold text-[7px] sm:text-[12px] lg:text-[18px] 2xl:text-2xl py-2 md:py-6'>Why Nex2Link</h3>
