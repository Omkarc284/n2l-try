...
const Cards = ({index, props}) => {
  return (
    ...
    >
      ...
      >
        <img src={props.image} className='scale-50 sm:scale-75 md:scale-50 lg:scale-100 absolute top-2 right-2 lg:right-6 lg:top-8 md:group-hover:scale-[60%] lg:group-hover:scale-110'/>
        <h1 className='font-montserrat font-bold text-[#5B5D5C] text-[12px] lg:text-[24px] pt-16 w-[108px] md:w-[72px] lg:w-[176px] group-hover:text-white'>{props.title}</h1>
        <p className='w-[144px] md:w-[128px] lg:w-[256px] font-montserrat font-light text-[7px] lg:text-[12px] group-hover:text-white'>{props.description}</p>
...
const Home = () => {
  return (
    ...
    <div className=' w-full h-full flex justify-center'>
        <div className=" max-w-[360px] md:max-w-[640px] lg:max-w-[1080px] xl:max-w-[1280px] justify-center h-full flex flex-col pt-[96px] lg:pt-[144px]">
            ...
            <div className="md:-mt-8 lg:-mt-36 w-full grid grid-flow-row md:gap-3 lg:gap-8 justify-between grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
                {     
