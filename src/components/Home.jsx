...
const Home = () => {
  return (
    ...
    <div className=' w-full h-full flex justify-center'>
        <div className=" max-w-[360px] md:max-w-[640px] lg:max-w-[1080px] xl:max-w-[1280px] justify-center h-full flex flex-col md:pt-[96px] lg:pt-[144px]">
            ...
            <div className="md:-mt-8 xl:-mt-36 w-full grid grid-flow-row gap-3 lg:gap-8 justify-between grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
                {     
